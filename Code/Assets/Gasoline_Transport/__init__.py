...
class Gasoline_Transport_Asset(Asset_STEVFNs):
    """Class of Gasoline Transport asset"""
    asset_name = "Gasoline_Transport"
    source_node_type = "Gasoline"
    target_node_type = "Gasoline"
    transport_time = 0 #for now
