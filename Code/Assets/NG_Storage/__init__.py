...
class NG_Storage_Asset(Asset_STEVFNs):
    """Class of NG Storage asset"""
    asset_name = "NG_Storage"
    source_node_type = "NG"
    target_node_type = "NG"
    ...
    def get_times(self):
        return np.arange(self.asset_structure["Start_Time"], self.asset_structure["End_Time"], self.asset_structure["Period"])